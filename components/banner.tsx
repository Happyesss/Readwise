...
const BANNER_KEY = "hide-readwise-banner";
        ...
        <div className="flex items-center justify-center">
          <p className="text-sm font-normal">
            ...
            <strong className="font-semibold">
              Welcome to ReadWise - Dyslexia Learning Platform!
            </strong>{" "}
            Now powered by Supabase for authentication and database.
            {links?.sourceCode ? (
              <>
                ...
                <Link
                  ...
                  className="text-purple-600 transition-opacity hover:opacity-75"
                >
                  fork this repo
                </Link>
              </>
